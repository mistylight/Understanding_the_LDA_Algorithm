...
if __name__ == "__main__":
    ...
    print("============= Example SpaCy output: =============")
    input_text = "spaCy is awesome! 123"
    clean_text = preprocessor.preprocess_text(input_text)
    print(input_text, "==>", clean_text)
    print("=================================================")

    with open("papers_raw.txt") as fin, open("papers.txt", "w") as fout:
        for input_text in tqdm(fin):
            clean_text = preprocessor.preprocess_text(input_text.strip())
